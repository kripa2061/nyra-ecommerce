...
//     try {
//       const response = await axios.get(`${url}/api/product/getProductbyid/${id}`, { withCredentials: true });
//       if (response.data) {
...
//     try {
//       const response = await axios.get(`${url}/api/product/getReview/${id}`, { withCredentials: true });
//       if (response.data) {
...
//             <img src={product.images?.[selectedImage]} alt={product.name} className="pd-main-img" />
//           </div>
